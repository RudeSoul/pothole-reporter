...
grep -Fq 'android:versionCode="31"' "$BUNDLE_MANIFEST" || fail "expected versionCode 31"
grep -Fq 'android:versionName="1.13.3"' "$BUNDLE_MANIFEST" || fail "expected versionName 1.13.3"
