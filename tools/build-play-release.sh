...
grep -Fq 'android:versionCode="68"' "$BUNDLE_MANIFEST" || fail "expected versionCode 68"
grep -Fq 'android:versionName="1.38.1"' "$BUNDLE_MANIFEST" || fail "expected versionName 1.38.1"
